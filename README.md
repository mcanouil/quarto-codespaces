...
- **Specific Quarto versions**:
  - `.devcontainer/quarto-1.9/devcontainer.json` - Quarto 1.9
  - ...
  - `.devcontainer/quarto-1.0/devcontainer.json` - Quarto 1.0
...
[View build log](https://github.com/mcanouil/quarto-codespaces/actions/runs/25272478175)
